...
<table border="0" cellpadding="0" cellspacing="0"><tbody><tr><td>12</td><td><code>HttpSession session = request.getSession();</code><code>session.getAttribute(</code><code>"isLogin"</code><code>);</code></td></tr></tbody></table>
